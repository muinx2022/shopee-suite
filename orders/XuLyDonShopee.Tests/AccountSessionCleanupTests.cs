...
/// <summary>
/// Test hàm thuần <see cref="OrderPersistPipeline.NenXoaDonKetThuc"/> — quyết định một đơn KẾT THÚC (Đã giao / Đã hủy)
...
public class AccountSessionCleanupTests
{
    ...
    public void Terminal_Settled_KhongSku_HubTat_Xoa()
    {
        ...
        Assert.True(OrderPersistPipeline.NenXoaDonKetThuc(p, gsheetSettled: true, hubHookActive: false, coPhieuLocalChuaDayHub: false));
    }
    ...
    public void DaGiao_CoSku_ChuaDem_Giu()
    {
        ...
        Assert.False(OrderPersistPipeline.NenXoaDonKetThuc(p, gsheetSettled: true, hubHookActive: false, coPhieuLocalChuaDayHub: false));
    }
    ...
    {
        var p = Make("SN", status: "Đã hủy");
        Assert.False(OrderPersistPipeline.NenXoaDonKetThuc(p, gsheetSettled: false, hubHookActive: false, coPhieuLocalChuaDayHub: false));
    }
    ...
    public void HubBat_ChuaDayHub_Giu()
    {
        ...
        Assert.False(OrderPersistPipeline.NenXoaDonKetThuc(p, gsheetSettled: true, hubHookActive: true, coPhieuLocalChuaDayHub: false));
    }
    ...
    public void HubBat_DaDayHub_Xoa()
    {
        ...
        Assert.True(OrderPersistPipeline.NenXoaDonKetThuc(p, gsheetSettled: true, hubHookActive: true, coPhieuLocalChuaDayHub: false));
    }
    ...
    public void CoPhieuLocalChuaDayHub_Giu()
    {
        ...
        var p = Make("SN", status: "Đã hủy");
        Assert.False(OrderPersistPipeline.NenXoaDonKetThuc(p, gsheetSettled: true, hubHookActive: false, coPhieuLocalChuaDayHub: true));
    }
    ...
    public void HubBat_DaDayHub_CoPhieuLocalChuaDayPhieu_Giu()
    {
        ...
        var p = Make("SN", status: "Đã giao", sku: null, daDayHub: true);
        Assert.False(OrderPersistPipeline.NenXoaDonKetThuc(p, gsheetSettled: true, hubHookActive: true, coPhieuLocalChuaDayHub: true));
    }
