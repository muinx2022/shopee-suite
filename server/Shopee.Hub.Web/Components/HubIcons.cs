...
public static class HubIcons
{
    private static readonly Dictionary<string, string> Paths = new()
    {
        ...
        // Giao việc (/dispatch) — bia ngắm: "nhắm việc vào đúng máy", không đụng hình nào đang dùng.
        ["dispatch"] = "<circle cx='12' cy='12' r='9'/><circle cx='12' cy='12' r='3.5'/><path d='M12 1.5v3M12 19.5v3M1.5 12h3M19.5 12h3'/>",
