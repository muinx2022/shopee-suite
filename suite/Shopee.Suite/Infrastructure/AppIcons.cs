...
/// <c>IconDelete</c>… ) để CẢ HAI module dùng chung MỘT NGUỒN: chiều tham chiếu là
/// <c>Shopee.Suite → XuLyDonShopee.App</c> nên bộ icon phải nằm bên orders thì module Đơn hàng mới với tới.
/// <b>BẢNG ÁNH XẠ CHUẨN "mỗi hành động ĐÚNG MỘT icon" nay ở đầu file Icons.axaml đó</b> — tra ở đó, đừng
/// thêm icon hành động vào đây (nhân bản = lại lệch nhau như trước).
/// </para>
/// <para>
