...
public sealed class AccountItemViewModel : ObservableObject
{
    ...
    /// <summary>Màu chữ cột Tình trạng theo giá trị (xanh=đang · accent=đã · đỏ=captcha · xám=chưa).
    /// Brush lấy từ <see cref="AppBrushes"/> (đã Freeze) vì dòng lưới có thể dựng từ luồng nền.</summary>
    public Brush UsageStatusBrush => UsageStatus switch
    {
        "Đang dùng" => AppBrushes.Success,
        "Đã dùng" => AppBrushes.Accent,
        "⚠ Captcha" => AppBrushes.Danger,
        _ => AppBrushes.Muted,
    };
